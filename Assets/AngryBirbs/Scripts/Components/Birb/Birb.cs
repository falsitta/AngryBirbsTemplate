...
public class Birb : MonoBehaviour
{
    ...
    {
        float stretchLength;
        stretchLength = Vector2.Distance(transform.position, offset);

        float stretchPower = stretchLength / maximumStretch + 5f;

        rigidbody.AddForce(-offset * stretchPower, ForceMode2D.Impulse);
